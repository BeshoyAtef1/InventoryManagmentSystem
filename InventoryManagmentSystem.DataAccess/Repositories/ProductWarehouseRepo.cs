...
{
    public class ProductWarehouseRepo : GenericRepository<ProductWarehouse> , IProductWarehouseRepo
    {
        private readonly AppDbContext appDbContext;

        public ProductWarehouseRepo(AppDbContext appDbContext) : base(appDbContext)
        { 
